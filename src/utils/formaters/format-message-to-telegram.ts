...
export async function formatMessageToTelegram(promotion: IPromotion, affiliateLink: string) {
    try {
        ...
        const amazonRegex =
            /^(https?:\/\/)?(www\.)?(amazon\.(com|com\.br|ca|co\.uk|de|es|fr|it|jp|nl|sg|com\.mx|com\.au|in)|amzn\.to)\/.+/i;
